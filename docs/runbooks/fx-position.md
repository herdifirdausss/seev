...
A non-zero balance on the currency member that DID post is the visible proof of the open position — that's by design (docs/plan/18 K-S S2 decision): FX positions are meant to be visible in the account balance, not hidden.
