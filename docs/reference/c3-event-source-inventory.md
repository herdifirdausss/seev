...
| Ledger outbox | `ledger.dispute.lifecycle.v1` | Gateway `ledger.events.notifications` | Dispute `open`/evidence/terminal state → compliance notification and durable delivery plan |
