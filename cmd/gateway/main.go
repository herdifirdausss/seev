...
func main() {
	...
	notifyCfg := notify.Config{
		Enabled: cfg.Notify.Enabled, InAppEnabled: cfg.Notify.InAppEnabled, EmailEnabled: cfg.Notify.EmailEnabled,
		PushEnabled: cfg.Notify.PushEnabled, DigestEnabled: cfg.Notify.DigestEnabled,
		DefaultLocale: cfg.Notify.DefaultLocale, DefaultTimezone: cfg.Notify.DefaultTimezone,
		DigestHour: cfg.Notify.DigestHour, EventPrefetch: cfg.Notify.EventPrefetch, MaxEventAttempts: cfg.Notify.EventMaxAttempts,
		DeliveryBatch: cfg.Notify.DeliveryBatch, DeliveryLease: cfg.Notify.DeliveryLease, ProviderTimeout: cfg.Notify.ProviderTimeout,
		EmailWorkers: cfg.Notify.EmailWorkers, PushWorkers: cfg.Notify.PushWorkers, ContactWorkers: cfg.Notify.ContactWorkers,
		DigestWorkers: cfg.Notify.DigestWorkers, MaxDevices: cfg.Notify.MaxDevices, EncryptionRing: cryptoxRing,
		FingerprintKey: cfg.Notify.FingerprintKey, AuthContactURL: cfg.AuthInternalAPIURL, InternalToken: cfg.InternalGRPCToken,
	}
	contactClient := tlsx.HTTPClient(certSrc, tlsx.IdentityAuth, cfg.Notify.ProviderTimeout)
	contactResolver := &notify.HTTPContactResolver{BaseURL: cfg.AuthInternalAPIURL, Token: cfg.InternalGRPCToken, Client: contactClient}
	var emailSender *email.Sender
	if cfg.Notify.EmailEnabled {
		emailSender = email.NewSender(email.Config{Host: cfg.Notify.SMTPHost, Port: cfg.Notify.SMTPPort, Username: cfg.Notify.SMTPUsername, Password: cfg.Notify.SMTPPassword, From: cfg.Notify.SMTPFrom, ReplyTo: cfg.Notify.SMTPReplyTo, TLSMode: cfg.Notify.SMTPTLSMode, Timeout: cfg.Notify.ProviderTimeout})
	}
	var pushSender *push.Sender
	if cfg.Notify.PushEnabled {
		pushSender = push.NewSender(cfg.Notify.PushProviderURL, cfg.Notify.PushProviderToken, nil, cfg.Notify.ProviderTimeout)
	}
	notifyModule := notify.NewConfiguredModule(db, mq, notifyCfg, log, contactResolver, emailSender, pushSender)
