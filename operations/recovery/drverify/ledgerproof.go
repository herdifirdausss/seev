...
import (
	...
	"github.com/herdifirdausss/seev/services/assurance/rules"
)

// ledgerProofByCorrelation mirrors services/ledger/assurance.go's
...
// the one query shape services/ledger's own gRPC handler uses to answer
...
// bookedFee mirrors services/ledger/assurance.go's bookedFee exactly —
