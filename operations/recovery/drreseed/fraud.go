...
// velocityTTL mirrors services/fraud/internal/fraud/consumer.go's own unexported
...
func ReconstructFraudVelocity(ctx context.Context, ledgerDB *sql.DB, store fraud.VelocityStore, report *Report) error {
	...
	for _, raw := range rawEvents {
		...
		// Matches services/fraud/internal/fraud/consumer.go's handleDelivery exactly: an
