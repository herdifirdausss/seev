...
import (
	...
	"github.com/herdifirdausss/seev/internal/platform/resilience/egressproxy"
...
func run(parent context.Context) error {
	...
	// "money-safety, never optional" posture services/auth/cmd/auth and
	// services/ledger/cmd/ledger already hold their own rings to.
	...
	if cfg.Vendor.SecondaryMockVendorEnabled {
		if err := registry.Add("mockvendor2", internalvendor.NewMockAdapter("mockvendor2", cfg.Vendor.SecondaryMockVendorSecret)); err != nil {
