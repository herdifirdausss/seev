-- docs/roadmap/archive/51-a8-data-lifecycle-privacy.md "A8 T2.5b": services/payin/migrations/000010
-- dropped payin_webhook_events.raw — this function (services/payin/migrations/000009)
...
-- redaction simply NULLs raw_ciphertext/raw_key_version, and
-- "raw_ciphertext IS NOT NULL" alone is sufficient to exclude already-
-- redacted rows from a second pass (a row with NULL ciphertext has
