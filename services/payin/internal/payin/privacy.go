...
// into. Mirrors services/ledger/internal/ledger/closure's own Prepare/Commit
// shape (docs/roadmap/archive/51 T5) and services/auth's own export DTO
...
// layer, matching services/auth's own T4 convention) — deliberately
