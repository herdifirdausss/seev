...
import (
	...
	"github.com/herdifirdausss/seev/services/fraud/internal/sanctions"
)
...
func (r *SanctionsWatchlistRule) Screen(ctx context.Context, input model.ScreenInput) (model.Verdict, error) {
	...
	event := model.ScreeningEvent{ID: identifiers.NewV7(), TxType: input.TxType, UserID: input.UserID,
