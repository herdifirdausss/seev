...
// contracts/clients/fraud.Client checks for (docs/roadmap/archive/45 Task T3/K4) to
...
// contracts/clients/fraud: platform packages must remain independent of
// service implementations (docs/development/project-guide.md boundary rule),
// and this string is effectively part of the fraudv1 wire contract
