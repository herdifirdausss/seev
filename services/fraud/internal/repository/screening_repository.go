...
//go:generate mockgen -source=screening_repository.go -destination=screening_repository_mock.go -package=repository
...
func (r *screeningRepo) InsertEvent(ctx context.Context, ev model.ScreeningEvent) error {
	_, err := r.db.ExecContext(ctx, `
		...
		nulls.String(ev.RequestID), nulls.String(ev.Flow),
	)
	if err != nil {
