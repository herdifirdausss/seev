...
// internal/platform/cache.FailoverLimiter/FailoverCounter, there is NO memory fallback
...
// attempt inherits the CALLER's full remaining deadline — contracts/clients/fraud's
