...
// contracts/clients/fraud's 500ms screenTimeout and fall through to fail-OPEN
...
func TestFailClosedVelocityStore_SlowFirstAttempt_FailsClosedWithinBudget(t *testing.T) {
	...
	// A generous caller deadline standing in for contracts/clients/fraud's real
...
// this store embeds — thoroughly proven by internal/platform/cache's own test suite
...
// all the way up through services/fraud/internal/transport/grpc; a plain string
