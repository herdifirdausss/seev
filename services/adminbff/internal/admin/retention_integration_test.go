...
// would skip entirely (see services/auth/internal/auth/retention_integration_test.go's
// setupAuthTestDB, same reasoning). This differs from
// services/ledger/internal/retention_integration_test.go's setupLedgerOnlyDB, which
...
// TestRetention_Runner_EndToEnd proves internal/platform/lifecycle/retention/worker.Runner wired
// against fn_retention_purge_sessions the same way services/adminbff/internal/admin/module.go's
