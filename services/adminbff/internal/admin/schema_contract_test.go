...
// Package adminbff proves the logout session-delete fix (services/adminbff/migrations/
...
// (services/adminbff/migrations/000001_core.up.sql line 35 grants only SELECT,
