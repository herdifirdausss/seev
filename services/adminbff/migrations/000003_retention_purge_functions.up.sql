...
-- signature (internal/platform/lifecycle/retention/worker.Class), excludes rows an adminbff_retention_holds
...
-- (services/adminbff/migrations/000001_core.up.sql) — it has never had DELETE, so
