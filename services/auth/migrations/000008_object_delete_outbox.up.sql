...
--
-- No DELETE grant is needed anywhere here — internal/platform/lifecycle/objectoutbox.Worker only
...
-- by internal/platform/lifecycle/objectoutbox.Worker, and only after the object store itself
