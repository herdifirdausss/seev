...
type DocumentStore interface {
	...
	// internal/platform/lifecycle/objectoutbox.Worker relies on this for safe retry after a
	// partial failure).
...
// SetDocumentKeyRing wires the internal/platform/security/crypto.Ring KYC document encryption
// uses (docs/roadmap/archive/51-a8-data-lifecycle-privacy.md T2.2 — services/auth/cmd/auth/main.go
...
// slot changes RowID, so internal/platform/security/crypto.Ring.Open fails closed (K2).
