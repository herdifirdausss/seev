...
// not part of auth's public facade; only services/auth and services/auth/cmd/auth
// construct the relay.
package worker
...
// internal/platform/scheduling LockProvider used by the other service workers) ensures only
