...
// *sql.Tx — the caller (services/ledger/internal/ledger/recon) owns transaction
...
// recon_items.raw have no plaintext column anymore (services/ledger/migrations/000030),
