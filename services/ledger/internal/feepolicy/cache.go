...
// own per-queryid call count (tools/loadprobe) already gives a cleaner,
...
// cacheKey's NUL-delimited join mirrors internal/platform/security/crypto.AAD.bytes()'s own
