...
// lifecycleCloseReason, services/ledger/internal/ledger/handle/service.go), Refund
...
// (services/ledger/migrations/000004_lifecycle_guard.up.sql) already allowed
...
func (p *Refund) ResolveAccounts(ctx context.Context, cmd Command) (ResolvedAccounts, string, error) {
	...
	merchantID, err := metadata.MetaUUID(cmd.Metadata, "merchant_account_id")
	if err != nil {
