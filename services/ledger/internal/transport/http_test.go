...
// tests (services/ledger/internal/ledger/execquote_integration_test.go) prove execTransfer's
...
// non-default feePolicy (the shape services/ledger.Module.SetFeeRules
