...
// direct-DELETE-still-forbidden) and internal/platform/lifecycle/retention/worker.Runner wired
...
func TestRetention_FeeQuotesConsumed_ProofAware(t *testing.T) {
	...
	// 'fee' accounts are seeded by services/ledger/migrations/000002 (system
...
// TestRetention_Runner_EndToEnd proves internal/platform/lifecycle/retention/worker.Runner
