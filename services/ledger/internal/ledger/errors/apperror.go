...
var (
	...
	// ErrPolicyLimitExceeded is returned by the shared money-movement command
	// boundary when a configured user transaction limit rejects a request. It
...
var (
	...
	// (services/ledger/migrations/000035_chargeback_disputes).
	...
	// finding, services/ledger/migrations/000038) — same atomic-UPDATE-with-status-
...
// businessRejectionSentinels mirrors services/ledger/internal/transport/errors.go's
