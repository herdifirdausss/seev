-- docs/roadmap/archive/16 Task T2 (K5): kolom korelasi eksternal — prasyarat rekonsiliasi.
-- Kolom INFORMATIF (sama seperti source/destination_account_id di 000001) —
-- the source of truth remains ledger_entries. There is NO backfill of old data;
-- only rows posted AFTER this migration are populated by service.go from
