-- docs/roadmap/archive/51-a8-data-lifecycle-privacy.md "A8 T2.5b": services/ledger/migrations/000030
-- dropped recon_batches.source_filename and recon_items.raw — these
-- functions (services/ledger/migrations/000027) wrote/read the plaintext columns
