...
-- writes each table (audited against services/ledger/internal/repository/*.go and
-- services/ledger/internal/ledger/*/*.go — zero DELETE statements anywhere in this
