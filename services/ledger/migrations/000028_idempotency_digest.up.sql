...
-- canonical, length-delimited (scope, key) value (internal/platform/security/crypto.DigestRing) —
...
-- digest (see services/ledger/internal/repository's own FindConflictOrDuplicate
