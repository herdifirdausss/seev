...
type Dependencies struct {
	...
	// goroutine (Start/Stop) is driven directly from services/gateway/cmd/gateway/main.go
	...
	// at /api/v1/b2b — built by services/gateway/internal/merchant/api.NewRouter in
	// services/gateway/cmd/gateway/main.go. nil (should never happen in production; only a
