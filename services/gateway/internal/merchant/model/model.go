// Package model holds services/gateway/internal/merchant's own domain types (docs/roadmap/archive/57-c1-merchant-b2b-api.md
...
// (§11.7). SecretCiphertext is sealed via internal/platform/security/crypto (T7); plaintext is
...
// services/auth.OperatorOffboardingRequest's own shape, generalized to
