...
// repository.WebhookRepository — matches services/gateway/internal/merchant/idempotency's
// own established hand-written-fake convention for this codebase (no
// gomock in services/gateway/internal/merchant). It reproduces the real implementation's
