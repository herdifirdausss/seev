...
// Operation IDs (contracts/http/b2b-v1.yaml) — also the keys registered in
// services/gateway/internal/merchant/auth's scope registry and the idempotency canonical
