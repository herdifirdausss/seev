...
// §1.2 requires — PayinService's own internal statuses (services/payin/internal/payin/model's
...
// internal statuses (services/payout/internal/payout/model's Status* constants) onto the
