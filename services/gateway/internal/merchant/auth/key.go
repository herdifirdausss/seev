// Package auth is services/gateway/internal/merchant's API-key verification and scope
// package (docs/roadmap/archive/57-c1-merchant-b2b-api.md §3.1, T3). It has no
// dependency on AuthService or internal/platform/security/middleware.Claims — a merchant API key
