// Package repository is services/gateway/internal/merchant's Gateway-owned persistence layer
...
// lives in services/gateway/internal/merchant/idempotency (T4), not here — this is
// persistence only.
...
// application layer (services/gateway/internal/merchant.GlobalFlag) treats "no row" as the
