...
// Package repository_test proves services/gateway/internal/merchant/repository's tenant
...
// cluster-wide, not per-database, and services/ledger/migrations/000009_rls_roles.up.sql
...
// this — same two-step order services/gateway/internal/notification's own integration test
