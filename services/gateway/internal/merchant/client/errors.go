// Package client holds services/gateway/internal/merchant's typed Gateway-side clients to
...
// translates gRPC status codes into. services/gateway/internal/merchant/api maps each one
