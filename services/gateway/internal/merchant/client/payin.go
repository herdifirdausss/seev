...
// deliberately its own type, not payinv1.TopupIntent, so services/gateway/internal/merchant/api
...
// (docs/reference/c1-b2b-design.md §1.2) is services/gateway/internal/merchant/api's job,
// not this package's.
