...
// hand-written-fake convention for services/gateway/internal/merchant subpackages (no
...
func TestService_Propose_RejectsInvalidAction(t *testing.T) {
	...
	_, err := svc.Propose(context.Background(), identifiers.NewV7(), "explode", "maker@x.com", "reason")
