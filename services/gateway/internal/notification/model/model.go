...
const (
	...
	KindDisputeLifecycle     = "compliance.dispute.lifecycle"
...
// DisputeContext is the bounded, notification-safe projection of a dispute
// lifecycle event. Evidence references, actor identities, and resolution
// reasons stay in the Ledger audit surface and are never rendered into user
// notifications.
type DisputeContext struct {
	ID            string `json:"id"`
	Reference     string `json:"reference"`
	Status        string `json:"status"`
	EvidenceDueAt string `json:"evidence_due_at,omitempty"`
}
...
type RenderContext struct {
	...
	Dispute        DisputeContext     `json:"dispute,omitempty"`
}
