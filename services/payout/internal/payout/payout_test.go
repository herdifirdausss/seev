...
// services/ledger/internal/transport/http_test.go and services/payin/internal/payin/payin_test.go
...
// services/payin's own stubPoster, docs/roadmap/archive/22 Task T2).
...
// interface contract (mirrors services/payin's stubVerifier pattern) —
