...
const (
	...
	// services/ledger/internal/worker.OutboxRelay's dbCallTimeout. It does NOT bound
	...
	// here — see services/payout/internal/payout/relay.go).
...
// resumer above and services/ledger/internal/worker.OutboxRelay's own repo
...
// dispatch as two separate steps; see services/payout/internal/payout/relay.go.
...
// four-loop shape as services/ledger/internal/worker.OutboxRelay (poll/retry/reap/
