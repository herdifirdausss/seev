// Package worker holds services/payout's background job(s). Not part of the
// module's public facade — only services/payout itself may import this
// package (docs/roadmap/archive/01-target-architecture.md, enforced by
// boundary_test.go), mirroring services/ledger/internal/worker's boundary.
package worker
...
// services/ledger/internal/worker.scheduleRunner.
