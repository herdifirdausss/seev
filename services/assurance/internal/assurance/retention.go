...
// dedicated scheduler. Unlike services/auth/internal/auths/gateway/internal/notification's own
// StartRetentionRunner, this always uses an in-memory lock: this service
// has no Redis dependency anywhere else in its wiring (services/assurance/cmd/assurance/main.go),
