...
// internal/platform/transport/grpc and every internal HTTP server/client in this repo
// (docs/roadmap/archive/49 K2). Identity is a SPIFFE-style URI SAN
// ("spiffe://seev/<service>"), never a Common Name — internal/platform/security/tls never
...
// their identity here AND to tools/certgen's known-service list — an
