...
import (
	...
	pingv1 "github.com/herdifirdausss/seev/gen/go/ping/v1"
...
// through the real grpcx.NewServer/dial code path every services/*/cmd/*/main.go uses
// (not just internal/platform/security/tls's own lower-level TLS test): a client certificate that
