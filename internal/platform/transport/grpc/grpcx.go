...
// internal/platform/security/tls.ServerConfig) is the primary control, the token is retained as
...
// internal/platform/security/middleware.WithTracing/WithLogger for HTTP, stores a span- and
