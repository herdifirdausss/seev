...
// deliberately its own type, not payoutv1.Payout, so internal/merchant/api
...
// public enum (docs/reference/c1-b2b-design.md §1.3) is internal/merchant/api's
...
// (internal/handler/payout.go's payoutResponse) — the caller already has
