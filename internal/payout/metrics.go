...
// vendorCommandAttemptsTotal is docs/roadmap/archive/45 K6's
...
// derived from request input (docs/roadmap/archive/43 K7 cardinality discipline).
var vendorCommandAttemptsTotal = promauto.NewCounterVec(prometheus.CounterOpts{
	Namespace: "payout",
	Name:      "vendor_command_attempts_total",
	Help:      "Vendor dispatch command attempts by outcome (docs/roadmap/archive/45 K6).",
}, []string{"outcome"})
