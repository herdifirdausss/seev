...
// SetClosureKeyRing wires the pkg/cryptox.Ring the closure saga's
...
// T5b) — order is fixed at registration time (cmd/auth-service/main.go's
...
// name (would register a duplicate, not overwrite) — cmd/auth-service's
