...
func (m *Module) CreateExportHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		export, err := m.RequestExport(r.Context(), userID, req.Password)
		if err != nil {
...
func (m *Module) ExportStatusHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		export, err := m.GetExportStatus(r.Context(), userID, id)
		if err != nil {
			writeExportError(w, err)
			return
		}
...
func (m *Module) DownloadExportHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		content, err := m.DownloadExport(r.Context(), userID, id, password)
		if err != nil {
			writeExportError(w, err)
			return
		}
