...
// there for Redis-vs-in-memory fallbacks (docs/roadmap/archive/12 Task T1). Adding a
// real vendor later is one new subpackage plus one registration line in
// main.go; internal/payin's code never changes (docs/roadmap/archive/21 K-T6).
...
// Payin return false, which the webhook receiver maps to 404 (docs/roadmap/archive/22
// Task T3), not a 500.
