...
// without an import cycle (docs/roadmap/archive/05 Task 1b.4).
package transport
...
type Service interface {
	...
	// router's fee policy (docs/roadmap/archive/18 Task T2) to pick the right
	...
	// replay (docs/roadmap/archive/15 Task T1).
	...
	// a period (docs/roadmap/archive/15 Task T2).
	...
	// dead-letter replay endpoints (docs/roadmap/archive/12 Task T3) — internal
	...
	// (docs/roadmap/archive/25 Task T5) — internal router only, admin-gated.
	...
	// reconciliation endpoints (docs/roadmap/archive/16 Task T2) — internal router
	...
	// back the scheduled-transaction endpoints (docs/roadmap/archive/19 Task T1) —
	...
	// endpoints (docs/roadmap/archive/19 Task T3) — internal router only, admin-gated.
	...
	// back the regulatory reporting endpoint (docs/roadmap/archive/20 Task T2) —
