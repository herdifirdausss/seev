...
// C5InterestRepository is the Ledger-owned persistence boundary for the
...
type C5InterestRepository interface {
...
type c5InterestRepo struct{ db database.DatabaseSQL }

func NewC5InterestRepository(db database.DatabaseSQL) C5InterestRepository {
	return &c5InterestRepo{db: db}
}

func (r *c5InterestRepo) CreateProduct(ctx context.Context, product model.SavingsProduct) (model.SavingsProduct, error) {
	if product.ID == uuid.Nil {
		product.ID = generalutil.NewV7()
	}
	if product.PublicID == "" {
...
func (r *c5InterestRepo) GetProduct(ctx context.Context, id uuid.UUID) (model.SavingsProduct, error) {
...
func (r *c5InterestRepo) ListProducts(ctx context.Context, status string) ([]model.SavingsProduct, error) {
...
func (r *c5InterestRepo) UpdateProductStatus(ctx context.Context, id uuid.UUID, status, checker string) error {
...
func (r *c5InterestRepo) CreateRate(ctx context.Context, rate model.SavingsRateVersion) (model.SavingsRateVersion, error) {
	if rate.ID == uuid.Nil {
		rate.ID = generalutil.NewV7()
	}
	if rate.PublicID == "" {
...
func (r *c5InterestRepo) SubmitRate(ctx context.Context, id uuid.UUID, submittedBy string) error {
...
func (r *c5InterestRepo) ApproveRate(ctx context.Context, id uuid.UUID, checker string) error {
...
func (r *c5InterestRepo) RejectRate(ctx context.Context, id uuid.UUID, checker, reason string) error {
	result, err := r.db.ExecContext(ctx, `UPDATE savings_rate_versions
...
func (r *c5InterestRepo) GetRateForDate(ctx context.Context, productID uuid.UUID, date time.Time) (model.SavingsRateVersion, error) {
...
func (r *c5InterestRepo) CreateEnrollment(ctx context.Context, enrollment model.SavingsEnrollment) (model.SavingsEnrollment, error) {
	if enrollment.ID == uuid.Nil {
		enrollment.ID = generalutil.NewV7()
	}
	...
	err := r.db.WithTx(ctx, nil, func(tx *sql.Tx) error {
		...
		_, err := tx.ExecContext(ctx, `INSERT INTO savings_enrollment_status_history
			...
			VALUES ($1,$2,$3,$4,$5)`, generalutil.NewV7(), enrollment.ID,
...
func (r *c5InterestRepo) GetEnrollment(ctx context.Context, id uuid.UUID) (model.SavingsEnrollment, error) {
...
func (r *c5InterestRepo) ListEnrollments(ctx context.Context, userID uuid.UUID) ([]model.SavingsEnrollment, error) {
...
// UpdateEnrollmentStatus is intentionally kept off C5InterestRepository so
...
func (r *c5InterestRepo) UpdateEnrollmentStatus(ctx context.Context, id uuid.UUID, status, actor string, effectiveUntil *time.Time) error {
...
func (r *c5InterestRepo) UpdateEnrollmentStatusWithEffectiveDate(ctx context.Context, id uuid.UUID, status, actor string, effectiveFrom, effectiveUntil *time.Time) error {
	...
	err := r.db.WithTx(ctx, nil, func(tx *sql.Tx) error {
		...
		_, err = tx.ExecContext(ctx, `INSERT INTO savings_enrollment_status_history
			...
			ON CONFLICT (enrollment_id,effective_from) DO UPDATE SET
				status=EXCLUDED.status,changed_by=EXCLUDED.changed_by`, generalutil.NewV7(), id,
...
func (r *c5InterestRepo) ListActiveEnrollments(ctx context.Context, date time.Time) ([]model.SavingsEnrollment, error) {
...
func (r *c5InterestRepo) ListEnrollmentAccruals(ctx context.Context, enrollmentID uuid.UUID) ([]model.InterestDailyAccrual, error) {
...
func (r *c5InterestRepo) EnsurePeriod(ctx context.Context, period model.InterestPeriod) (model.InterestPeriod, error) {
	if period.ID == uuid.Nil {
		period.ID = generalutil.NewV7()
	}
	if period.PublicID == "" {
...
func (r *c5InterestRepo) GetPeriod(ctx context.Context, id uuid.UUID) (model.InterestPeriod, error) {
...
func (r *c5InterestRepo) IsPreviousPeriodClosed(ctx context.Context, periodID uuid.UUID) (bool, error) {
	var closed bool
	...
	if err != nil { return false, fmt.Errorf("check previous interest period: %w", err) }
	return closed, nil
}

func (r *c5InterestRepo) ListEnrollmentPeriods(ctx context.Context, enrollmentID uuid.UUID) ([]model.InterestPeriod, error) {
...
func (r *c5InterestRepo) ListEnrollmentCapitalizations(ctx context.Context, enrollmentID uuid.UUID) ([]model.InterestCapitalizationItem, error) {
...
func (r *c5InterestRepo) RefreshExpectedItemCount(ctx context.Context, periodID uuid.UUID) error {
...
func (r *c5InterestRepo) CountEligibleEnrollments(ctx context.Context, periodID uuid.UUID) (int, error) {
	var count int
...
func (r *c5InterestRepo) HasNonActiveCapitalizationAccount(ctx context.Context, periodID uuid.UUID) (bool, error) {
	var blocked bool
...
func (r *c5InterestRepo) ListDuePeriods(ctx context.Context, now time.Time) ([]model.InterestPeriod, error) {
...
func (r *c5InterestRepo) MarkPeriodStatus(ctx context.Context, tx *sql.Tx, id uuid.UUID, status, code string) error {
...
func (r *c5InterestRepo) CreateOrGetDailyAccrual(ctx context.Context, item model.InterestDailyAccrual) (model.InterestDailyAccrual, error) {
	if item.ID == uuid.Nil {
...
func (r *c5InterestRepo) ClaimDailyAccrual(ctx context.Context, owner string, now time.Time) (model.InterestDailyAccrual, error) {
	var item model.InterestDailyAccrual
...
func (r *c5InterestRepo) ClaimDailyAccrualForID(ctx context.Context, id uuid.UUID, owner string, now time.Time) (model.InterestDailyAccrual, error) {
	var item model.InterestDailyAccrual
...
func (r *c5InterestRepo) GetCarryBeforeDate(ctx context.Context, enrollmentID uuid.UUID, date time.Time) (carry, denominator string, found bool, err error) {
	var status string
...
func (r *c5InterestRepo) SaveDailyCalculation(ctx context.Context, tx *sql.Tx, item model.InterestDailyAccrual) error {
...
func (r *c5InterestRepo) CompleteDailyAccrual(ctx context.Context, tx *sql.Tx, id uuid.UUID, status string, transactionID *uuid.UUID, carryNumerator, carryDenominator string) error {
...
func (r *c5InterestRepo) FailDailyAccrual(ctx context.Context, id uuid.UUID, status, errorCode string, nextAttempt time.Time) error {
...
func (r *c5InterestRepo) RetryDailyAccrual(ctx context.Context, id uuid.UUID) error {
...
func (r *c5InterestRepo) ListPeriodAccruals(ctx context.Context, periodID uuid.UUID) ([]model.InterestDailyAccrual, error) {
...
func (r *c5InterestRepo) EnsureCapitalizationItems(ctx context.Context, periodID uuid.UUID) error {
...
func (r *c5InterestRepo) ListCapitalizationItems(ctx context.Context, periodID uuid.UUID) ([]model.InterestCapitalizationItem, error) {
...
func (r *c5InterestRepo) StartCapitalization(ctx context.Context, id uuid.UUID, owner string, now time.Time) (model.InterestCapitalizationItem, error) {
	var item model.InterestCapitalizationItem
...
func (r *c5InterestRepo) CompleteCapitalization(ctx context.Context, tx *sql.Tx, id uuid.UUID, status string, transactionID *uuid.UUID) error {
...
func (r *c5InterestRepo) FailCapitalization(ctx context.Context, id uuid.UUID, status, errorCode string, nextAttempt time.Time) error {
	var nextArg any = nextAttempt
	if nextAttempt.IsZero() {
		nextArg = nil
	}
...
func (r *c5InterestRepo) RetryCapitalization(ctx context.Context, id uuid.UUID) error {
...
func (r *c5InterestRepo) PutPeriodCheck(ctx context.Context, check model.InterestPeriodCheck) error {
...
func (r *c5InterestRepo) CreateAdjustment(ctx context.Context, adjustment model.InterestAdjustment) (model.InterestAdjustment, error) {
	if adjustment.ID == uuid.Nil {
		adjustment.ID = generalutil.NewV7()
	}
...
func scanInterestAdjustment(scan func(dest ...any) error) (model.InterestAdjustment, error) {
	...
	if accrualID.Valid { value, err := uuid.Parse(accrualID.String); if err != nil { return model.InterestAdjustment{}, err }; adjustment.SourceAccrualID = &value }
	if capitalizationID.Valid { value, err := uuid.Parse(capitalizationID.String); if err != nil { return model.InterestAdjustment{}, err }; adjustment.SourceCapitalizationID = &value }
	if approvedBy.Valid { adjustment.ApprovedBy = &approvedBy.String }
	if transactionID.Valid { value, err := uuid.Parse(transactionID.String); if err != nil { return model.InterestAdjustment{}, err }; adjustment.LedgerTransactionID = &value }
	if approvedAt.Valid { adjustment.ApprovedAt = &approvedAt.Time }
	if postedAt.Valid { adjustment.PostedAt = &postedAt.Time }
	return adjustment, nil
}

func (r *c5InterestRepo) GetAdjustment(ctx context.Context, id uuid.UUID) (model.InterestAdjustment, error) {
	...
	if errors.Is(err, sql.ErrNoRows) { return model.InterestAdjustment{}, fmt.Errorf("interest adjustment %s: %w", id, sql.ErrNoRows) }
	if err != nil { return model.InterestAdjustment{}, fmt.Errorf("get interest adjustment: %w", err) }
	return item, nil
}

func (r *c5InterestRepo) ApproveAdjustment(ctx context.Context, id uuid.UUID, checker string) error {
...
func (r *c5InterestRepo) MarkAdjustmentPosted(ctx context.Context, id uuid.UUID, transactionID *uuid.UUID) error {
	return r.db.WithTx(ctx, nil, func(tx *sql.Tx) error {
...
// older test/migration doubles implementing C5InterestRepository remain
// source-compatible.
func (r *c5InterestRepo) MarkAdjustmentPostedTx(ctx context.Context, tx *sql.Tx, id uuid.UUID, transactionID *uuid.UUID) error {
	...
	if err != nil { return fmt.Errorf("mark interest adjustment posted: %w", err) }
