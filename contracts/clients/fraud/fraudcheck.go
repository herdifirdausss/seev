...
// copy of services/ledger/internal/transport/http.go's logic.
//
...
// services/fraud/internal/transport/grpc's own dependencyUnavailableMessage exactly —
// see that constant's doc comment for why this is a duplicated literal
// rather than a shared import (platform packages must remain independent of
