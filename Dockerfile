...
COPY . .
RUN set -eu; \
    for service in gateway auth-service ledger-service payin-service payout-service fraud-service vendor-service admin-bff-service assurance-service; do \
...
EXPOSE 8080 8081 8082 8083 8090 8091 8092 8093 8094 8095 8096 8098 9091 9092 9093 9094 9098
