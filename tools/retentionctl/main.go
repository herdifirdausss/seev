...
import (
	...
	"github.com/herdifirdausss/seev/internal/platform/lifecycle/retention/policy"
	"github.com/herdifirdausss/seev/internal/platform/lifecycle/retention/worker"
)

// ownerPattern is the same defensive, Go-side constraint internal/platform/lifecycle/retention/worker
// and internal/platform/lifecycle/objectoutbox apply to owner-derived identifiers before
