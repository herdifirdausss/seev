...
import (
	...
	"github.com/herdifirdausss/seev/tools/load/lab"
)
...
func main() {
	...
	printLogicalCPUs := flag.Bool("print-logical-cpus", false, "print the selected profile's logical CPU budget and exit")
	flag.Parse()
	...
	if *printLogicalCPUs {
		fmt.Println(profile.Resources.LogicalCPUs)
		return
	}
	if *manifestPath == "" {
		return
