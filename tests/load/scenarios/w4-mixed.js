import { authJson, json, semantic, stableKey, iterationOptions, handleSummary } from '../lib/common.js';
...
export default function () {
  ...
  if (selector < 7) semantic(json('POST', '/api/v1/ledger/fees/quote', { transaction_type: 'transfer_p2p', amount: '1000', currency: 'IDR' }, { 'Idempotency-Key': key }), 'mixed quote', [200, 201, 401, 403]);
  ...
  else semantic(authJson('GET', '/api/v1/users/me', null), 'mixed profile', [200, 401, 403]);
}
