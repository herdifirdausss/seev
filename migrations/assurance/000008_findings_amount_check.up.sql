...
-- (migrations/assurance/000001_core.up.sql) for findings that carry no
-- monetary magnitude of their own, and internal/assurance/finding.go's
...
-- (internal/assurance/metrics.go, http.go) instead of failing fast.
