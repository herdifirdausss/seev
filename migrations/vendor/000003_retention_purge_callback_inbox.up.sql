...
-- (migrations/payin/000009_retention_purge_webhook_raw.up.sql).
--
-- Terminal processing_status values mirror internal/vendorboundary/callback.go's
...
-- assurance.runs.succeeded (migrations/assurance/000006_retention_purge_functions.up.sql).
--
