...
-- (internal/ledger/repository/ledger_entry_repository.go), but at least one
-- existing integration test fixture (internal/drreseed/runner_integration_test.go's
...
-- one currency by design (see internal/ledger/processors/fx_in.go's own
