...
const (
	FraudService_Screen_FullMethodName = "/seev.fraud.v1.FraudService/Screen"
)
...
func (c *fraudServiceClient) Screen(ctx context.Context, in *ScreenRequest, opts ...grpc.CallOption) (*ScreenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ScreenResponse)
	err := c.cc.Invoke(ctx, FraudService_Screen_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFraudServiceServer) Screen(context.Context, *ScreenRequest) (*ScreenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Screen not implemented")
}
...
func _FraudService_Screen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScreenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FraudServiceServer).Screen(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FraudService_Screen_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FraudServiceServer).Screen(ctx, req.(*ScreenRequest))
	}
...
var FraudService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "seev.fraud.v1.FraudService",
	HandlerType: (*FraudServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Screen",
			Handler:    _FraudService_Screen_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "seev/fraud/v1/fraud.proto",
}
