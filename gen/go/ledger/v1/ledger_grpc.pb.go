...
const (
	...
	LedgerService_SetExecutionSubjectState_FullMethodName       = "/seev.ledger.v1.LedgerService/SetExecutionSubjectState"
...
type LedgerServiceClient interface {
	...
	SetExecutionSubjectState(ctx context.Context, in *SetExecutionSubjectStateRequest, opts ...grpc.CallOption) (*SetExecutionSubjectStateResponse, error)
...
func (c *ledgerServiceClient) SetExecutionSubjectState(ctx context.Context, in *SetExecutionSubjectStateRequest, opts ...grpc.CallOption) (*SetExecutionSubjectStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetExecutionSubjectStateResponse)
	err := c.cc.Invoke(ctx, LedgerService_SetExecutionSubjectState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LedgerServiceServer interface {
	...
	SetExecutionSubjectState(context.Context, *SetExecutionSubjectStateRequest) (*SetExecutionSubjectStateResponse, error)
...
func (UnimplementedLedgerServiceServer) GetTransactionByIdempotencyKey(context.Context, *GetTxByIdemKeyRequest) (*Transaction, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTransactionByIdempotencyKey not implemented")
}
func (UnimplementedLedgerServiceServer) GetUserCurrency(context.Context, *GetUserCurrencyRequest) (*GetUserCurrencyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserCurrency not implemented")
}
func (UnimplementedLedgerServiceServer) ResolveFee(context.Context, *ResolveFeeRequest) (*ResolveFeeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveFee not implemented")
}
func (UnimplementedLedgerServiceServer) ProvisionUser(context.Context, *ProvisionUserRequest) (*ProvisionUserResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ProvisionUser not implemented")
}
func (UnimplementedLedgerServiceServer) ConsumeFeeQuote(context.Context, *ConsumeFeeQuoteRequest) (*ConsumeFeeQuoteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConsumeFeeQuote not implemented")
}
func (UnimplementedLedgerServiceServer) ApplyKycTier(context.Context, *ApplyKycTierRequest) (*ApplyKycTierResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ApplyKycTier not implemented")
}
func (UnimplementedLedgerServiceServer) SetExecutionSubjectState(context.Context, *SetExecutionSubjectStateRequest) (*SetExecutionSubjectStateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetExecutionSubjectState not implemented")
}
...
func _LedgerService_SetExecutionSubjectState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetExecutionSubjectStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LedgerServiceServer).SetExecutionSubjectState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LedgerService_SetExecutionSubjectState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LedgerServiceServer).SetExecutionSubjectState(ctx, req.(*SetExecutionSubjectStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LedgerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetExecutionSubjectState",
			Handler:    _LedgerService_SetExecutionSubjectState_Handler,
		},
		{
