...
func (UnimplementedPayinServiceServer) HandleVendorCallback(context.Context, *HandleVendorCallbackRequest) (*HandleVendorCallbackResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method HandleVendorCallback not implemented")
}
func (UnimplementedPayinServiceServer) CreateTopupIntent(context.Context, *CreateTopupIntentRequest) (*CreateTopupIntentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateTopupIntent not implemented")
}
...
func (UnimplementedPayinServiceServer) GetIntakeControl(context.Context, *GetIntakeControlRequest) (*GetIntakeControlResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetIntakeControl not implemented")
}
func (UnimplementedPayinServiceServer) ApplyIntakeControl(context.Context, *ApplyIntakeControlRequest) (*ApplyIntakeControlResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ApplyIntakeControl not implemented")
}
...
func RegisterPayinServiceServer(s grpc.ServiceRegistrar, srv PayinServiceServer) {
	// If the following call panics, it indicates UnimplementedPayinServiceServer was
